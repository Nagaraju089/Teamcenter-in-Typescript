...
export async function sendOTP(req: Request, res: Response) {
   ...
   export async function verifyOTP(req: Request, res: Response) {
    ...
    //        // const type = redisValue.userData.user_type
    //         if(redisValue.userData.user_type == "admin") {
    //           next();
    //         }
    //          else {
    ...
    //   async function logout(req:Request, res:Request) {
    //    //const { scode } = req.body;
    //    //try {
